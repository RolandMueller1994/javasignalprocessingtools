function [real1,imag1] = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [REAL1,IMAG1] = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   [REAL1,IMAG1] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [real1,imag1] = importfile('TestFFT_Matlab_in.txt',1, 1001);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/07/04 20:04:11
